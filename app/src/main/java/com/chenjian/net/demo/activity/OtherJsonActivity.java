...
public class OtherJsonActivity extends Activity {
    ...
    private void gsonError() {
        ...
        NetHelper.get(urlParse.toString(), new NetSingleGsonListener<NetInfoBean>() {
            @Override
            protected void onError(CallbackCode errorCode, NetRetBean netRetBean) {
    ...
    private void fastjson() {
        ...
        NetHelper.get(urlParse.toString(), new NetSingleFastjsonListener<NetFastjsonBean>() {
            @Override
            protected void onError(CallbackCode errorCode, NetRetBean netRetBean) {
    ...
    private void fastjsonError() {
        ...
        NetHelper.get(urlParse.toString(), new NetSingleFastjsonListener<NetInfoBean>() {
            @Override
            protected void onError(CallbackCode errorCode, NetRetBean netRetBean) {
